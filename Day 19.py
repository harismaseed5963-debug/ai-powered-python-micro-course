...
# 1. Why Built-in Functions are important?
# 2. String Fuctions in Python
# 3. Numeric Functions in Python
# 4.List Functions in Python

# Practical Examples of the Day 19
