# # Learining Python - Day 30
# # 1. Data Analysis Project using Ai

# # Prompt:
# """ ROLE SETTING (Very Important)
# You are an expert Python software developer and data analyst.
# You have strong experience in:
# - Pandas for data analysis
# - Tkinter for GUI applications
# - Matplotlib for charts
# - Building corporate-ready desktop automation tools
#  PROJECT CONTEXT
...
#  Report Builder (Interactive Analysis)
# - Provide dropdowns for:
#  1. Group By Column (only text columns)
#  2. Aggregation Method (sum, mean, average, max, min, count, median)
#  3. Value Column (only numeric columns)
...
#  Chart Builder (GUI-Based Visualization)
